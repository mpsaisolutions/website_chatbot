...
5. Always mention stock status when discussing products`;
    ...
    initSupabase() {
        ...
        const SUPABASE_URL = 'https://eeqynxvdwvrdukmigtfr.supabase.co';
        const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVlcXlueHZkd3ZyZHVrbWlndGZyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjcwNzgwMDQsImV4cCI6MjA4MjY1NDAwNH0.7VCQ1GsnoCPAjFVdPZhnQRBuflj2Kv43zgnV58oNAmU';
